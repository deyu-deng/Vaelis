...
TIPS = [
    ...
    "Ctrl+Z suspends Vaelis to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Vaelis itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Vaelis home directory.",
    ...
    "hermes gateway install sets up Vaelis as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Vaelis tools programmatically — results stay out of context.",
    ...
    "When exiting, Vaelis prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Vaelis runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Vaelis via a local macOS server.",
    ...
    "Vaelis loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Vaelis as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Vaelis your own.",
    ...
    "Before a gateway session reset, Vaelis auto-flushes important facts to memory in the background.",
    ...
    "Profiles scope Vaelis state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Vaelis auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Vaelis config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Vaelis is working.',
    ...
    'hermes dashboard embeds the full Vaelis TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Vaelis block commands when the tirith scanner itself errors out.',
