...
def match_blueprint(query: str) -> Tuple[Optional[Any], List[Any]]:
    ...
    """
    from tools.blueprints import CATALOG, get_blueprint
...
def _humanize_schedule(blueprint) -> str:
    from tools.blueprints import _humanize_schedule as _h
...
def build_blueprint_seed(blueprint) -> str:
    ...
    """
    from tools.blueprints import WEEKDAY_PRESETS
...
def _fmt_catalog() -> str:
    from tools.blueprints import CATALOG
...
def handle_blueprint_command(
    ...
    *,
    ...
    """
    try:
        from tools.blueprints import fill_blueprint, BlueprintFillError
