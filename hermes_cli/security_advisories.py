"""
Security advisory checker for Vaelis Agent.
...
run in environments where the rest of Vaelis failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Vaelis requires 3.10+ but defensive.
        return None
    try:
