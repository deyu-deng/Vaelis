...
This is an additive Vaelis extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Vaelis head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Vaelis DB session id
