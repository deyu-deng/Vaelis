...
There are two ways to add a platform to the Vaelis gateway:
...
**zero changes to core Vaelis code**.
...
Checklist for integrating a platform directly into the Vaelis core.
