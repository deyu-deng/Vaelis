 ...
 * product name (`Vaelis`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *   '.../release/linux-unpacked/electron' -> '.../release/linux-unpacked/Vaelis'
 *
 ...
 * (the mac-unpacked Vaelis.app bundle) and Windows (win-unpacked), so we
