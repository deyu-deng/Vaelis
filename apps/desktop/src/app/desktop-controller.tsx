...
import { refreshAgendaTimeline, useAgendaTimeline } from './console/right/use-agenda-timeline'
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-2 pb-3">
          {agendaLoading && agendaEvents.length === 0 ? (
            ...
            <PanelEmpty
              ...
              icon="warning"
              title={t.console.timeline.loadFailed}
            />
          ) : agendaEvents.length === 0 ? (
            <PanelEmpty description={t.console.timeline.emptyDesc} icon="calendar" title={t.console.timeline.emptyTitle} />
          ) : (
            <Timeline events={agendaEvents} />
          )}
        </div>
      </aside>
    </Pane>
