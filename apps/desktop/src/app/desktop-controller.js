...
export function DesktopController() {
    ...
    const { agentsOpen, agendaOpen, chatOpen, closeOverlayToPreviousRoute, commandCenterInitialSection, commandCenterOpen, cronOpen, currentView, openAgents, openCommandCenterSection, openStarmap, profilesOpen, settingsOpen, starmapOpen, toggleCommandCenter } = useOverlayRouting();
    ...
    const { appendAssistantDelta, appendReasoningDelta, completeAssistantMessage, failAssistantMessage, handleGatewayEvent } = useMessageStream({
        activeSessionIdRef,
