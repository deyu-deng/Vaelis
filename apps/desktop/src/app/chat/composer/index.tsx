...
import { showsComposerCodingRow, shellLevelForPath } from '@/app/routes'
...
export function ChatBar() {
  // 裁定 40 (WP-L1-CHROME): resolve the secretary identity from the route, the
  // same way `use-composer-placeholder` already does — the chief secretary gets
  // no git branch/worktree strip above its mouth.
  const composerLevel = shellLevelForPath(useLocation().pathname)
        ...
        >
          ...
          <div className="relative w-full rounded-[inherit]">
            ...
            >
              ...
              />
              {showsComposerCodingRow(composerLevel) && (
                <CodingStatusRow
