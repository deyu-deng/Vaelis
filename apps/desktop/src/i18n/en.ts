...
export const en: Translations = {
  ...
  boot: {
    ready: 'Vaelis Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Vaelis settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Vaelis Desktop…'
    },
    errors: {
      backgroundExited: 'Vaelis background process exited.',
      backgroundExitedDuringStartup: 'Vaelis background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Vaelis backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Vaelis Desktop.',
    ...
    native: {
      ...
      inputBody: 'Vaelis is waiting for your response.',
      turnDoneTitle: 'Vaelis finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Vaelis defaults?',
    ...
    nav: {
      ...
      providerDesktopQuotas: 'Desktop Quotas',
      gateway: 'Gateway',
      apiKeys: 'Tools & Keys',
      keysTools: 'Tools',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Vaelis is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Vaelis asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Vaelis was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Vaelis follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Vaelis is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Vaelis, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Vaelis checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Vaelis configuration...',
    ...
    gateway: {
      ...
      intro:
        'Vaelis Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Vaelis backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Vaelis backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Vaelis backend.',
      remoteAuthHint:
        'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Vaelis Cloud',
      cloudDesc: 'Sign in once to Vaelis Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Vaelis Cloud',
      cloudSignIn: 'Sign in to Vaelis Cloud',
      cloudSignedIn: 'Signed in to Vaelis Cloud',
      cloudNeedsSignIn: 'Sign in to Vaelis Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Vaelis Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Vaelis Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Vaelis Cloud',
      cloudSignedOutMessage: 'Cleared the Vaelis Cloud session.',
      ...
      restartingMessage: 'Vaelis Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Vaelis ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Vaelis runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      desktopQuotas: {
        title: 'Desktop Quotas',
        intro:
          'Connect the desktop apps whose subscriptions Vaelis can route through. Sign in once — Vaelis handles the rest in the background.',
        connect: 'Connect',
        connected: 'Connected',
        notConnected: 'Not connected',
        connectError: provider => `Could not connect to ${provider}`,
        notVerified: 'Connection capture not yet verified for this app',
        useHub: 'Use this Hub',
  ...
  starmap: {
    ...
    emptyDesc: 'As Vaelis builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Vaelis to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Vaelis to generate pets.',
      backgroundHint: 'You can close this — Vaelis will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Vaelis desktop' },
    ...
    hermesActiveSessions: (version, count) => `Vaelis ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Vaelis environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  agenda: {
    ...
    endLabel: 'Ends',
    noEnd: 'no end time',
    senderLabel: 'Who said it',
    unknown: 'Unknown',
    locationLabel: 'Location',
    locationPlaceholder: 'e.g. East 2-101',
    notesLabel: 'Notes',
    notesPlaceholder: 'Optional',
    endBeforeStart: 'End cannot be earlier than start',
    rhythmOff: 'Rhythm not synced yet',
    confirm: 'Confirm',
    dismiss: 'Dismiss',
    ...
    collect: {
      ...
      activeShort: 'collecting',
      notStartedTitle: 'Not collecting yet',
      notStartedDesc: 'Review recent conversations first. Anything you don’t mark “collect” stays out of the index.',
      backlogTitle: 'Recent conversations',
      finishReview: 'Finish review & start collecting',
      pendingTitle: 'New conversations awaiting a choice',
      pendingEmptyTitle: 'No new conversations',
      pendingEmptyDesc: 'New talkers appear here for a one-click collect/exclude.',
      collect: 'Collect',
      exclude: 'Exclude',
  ...
  console: {
    ...
    agentsEmptyTitle: 'No agents yet',
    ...
    newAgentFolderLabel: 'Workspace folder',
    newAgentFolderPlaceholder: 'No folder selected yet',
    newAgentFolderPick: 'Choose folder',
    ...
    quotaTitle: 'Quota today',
    quotaUsed: (used: number, limit: number) => `${used} / ${limit}`,
    quotaUnits: {
      calls: 'model calls',
      tokens: 'tokens'
    },
    pendingCard: {
      ...
      oldValue: 'was',
      source: (source: string, snippet: string) => `${source}: “${snippet}”`,
      confirm: 'Confirm',
      dismiss: 'Ignore'
    },
    chat: {
      composerPlaceholder: 'Message the secretary…',
      send: 'Send',
      cancel: 'Stop',
      slashHint: (command: string, description: string) => `${command} — ${description}`,
      cardInvalid: 'This proposal could not be read.',
      cardConfirmed: 'Confirmed.',
      cardDismissed: 'Ignored.',
      cardFailed: 'Could not reach the agenda service. Try again.'
    },
    timeline: {
      title: 'Schedule',
      today: 'Today',
      ...
      emptyDesc: 'The secretary has nothing scheduled yet.',
      expand: 'Open full board',
      addEvent: 'Add event',
      addTitle: 'What',
      addTitlePlaceholder: 'e.g. dentist at 3pm',
      addStart: 'When',
      addSubmit: 'Add',
      addCancel: 'Cancel',
      pending: 'pending',
    ...
    supervisor: {
      ...
      loadFailed: 'Could not load this agent.',
      retry: 'Retry',
      statuses: {
        idle: 'idle',
        working: 'working',
      ...
      cost: (usd: number) => `$${usd.toFixed(2)}`,
      subagents: 'Sub-agents',
      outsourced: 'Outsourced apps',
      context: 'Context',
      memory: 'Memory',
      backToConsole: 'Back to console',
      workLogTitle: (subagent: string) => `${subagent} — work log`,
      logLoading: 'Loading the work log…',
      logFailed: 'Could not load this work log.',
      ...
      chat: {
        composerPlaceholder: 'Message this agent directly…',
        send: 'Send',
        cancel: 'Stop',
        slashHint: (command: string, description: string) => `${command} — ${description}`
      },
      filesEmpty: 'No project files yet.',
      boardEmpty: 'No board tasks yet.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Vaelis will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Vaelis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Vaelis. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Vaelis...',
    placeholderReconnecting: 'Reconnecting to Vaelis…',
    placeholderFollowUp: 'Send follow-up',
    secretaryL1Placeholder: 'Ask the chief secretary…',
    secretaryL2Placeholder: name => `Ask ${name}…`,
    ...
    attachUrlDesc: 'Vaelis will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Vaelis to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Vaelis…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Vaelis…',
    ...
    unsupportedMessage: 'This version of Vaelis can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Vaelis from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Vaelis will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Vaelis desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Vaelis updater takes over in its own window and reopens Vaelis automatically when it’s done. Please don’t reopen Vaelis yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Vaelis reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Vaelis reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Vaelis needs a one-time install',
    ...
    settingUpTitle: 'Setting up Vaelis Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Vaelis CLI or desktop instance is running. Stop any running Vaelis instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Vaelis Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Vaelis is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Vaelis…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Vaelis',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Vaelis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Vaelis connects automatically',
    ...
    authorizeThere: 'Authorize Vaelis there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Vaelis there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Vaelis Desktop v${version}`,
      ...
      gatewayTitle: 'Vaelis inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Vaelis will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Vaelis is restarting...',
      askRestart: 'Ask Vaelis to restart the server',
      lookingRestart: taskId => `Vaelis is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Vaelis is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Vaelis finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Vaelis could not restart the server.',
      stillWorking:
        'Vaelis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Vaelis is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Vaelis gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Vaelis won’t ask again for commands like this — in this session or any future one.`,
    ...
    tool: {
      ...
      mutate: {
        ...
        cancelMatching: {
          title: count => `Cancelled timetable · ${count}`,
          pending: 'Cancelling timetable',
          fromDate: date => `${date} onwards`,
          empty: 'No matching future classes',
          more: count => `+${count}`
        }
      },
      query: {
      ...
      project: {
        title: count => `Projects · ${count}`,
        viewing: 'Checking projects',
        hours: hours => `${hours}h / week`,
        noRhythm: 'no cadence',
        empty: 'No active projects'
      },
      planDay: {
        pending: 'Planning your day',
        title: (date, count) => `Planned · ${date} · ${count}`,
        empty: 'Nothing fits this day',
        conflicts: count => `${count} conflicts`
      },
      checkin: {
        pending: 'Noting your preference',
        title: count => `Waiting for you · confirm ${count}`,
        empty: 'No questions this time'
      },
      actions: {
        read: 'Read',
        reading: 'Reading',
  ...
  prompts: {
    ...
    sudoDesc: 'Vaelis needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Vaelis needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Vaelis Desktop to use Save Image.',
    restartToSaveImages: 'Restart Vaelis Desktop to save images',
