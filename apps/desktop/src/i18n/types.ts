...
export interface Translations {
  ...
  settings: {
    ...
    providers: {
      ...
      desktopQuotas: {
        ...
        connected: string
        notConnected: string
        connectError: (provider: string) => string
        notVerified: string
        useHub: string
        hubRunning: string
        hubStopped: string
  ...
  agenda: {
    ...
    endLabel: string
    noEnd: string
    /** WP-DAY-FACE: validation message when the end is set but before start. */
    endBeforeStart: string
    /** WP-DAY-FACE: field labels / placeholders the editor now needs. */
    locationLabel: string
    locationPlaceholder: string
    notesLabel: string
    notesPlaceholder: string
    /** WP-DAY-FACE: quiet banner when `/api/agenda/day` is unavailable. */
    rhythmOff: string
  ...
  console: {
    ...
    /** WP-STUDIO (裁定 36.1): workspace folder picker in the new-agent dialog. */
    newAgentFolderLabel: string
    newAgentFolderPick: string
    newAgentFolderPlaceholder: string
    ...
    quotaUnits: Record<string, string>
    pendingCard: {
      number: (seq: number) => string
      oldValue: string
      source: (source: string, snippet: string) => string
      confirm: string
      dismiss: string
    }
    chat: {
      ...
      send: string
      cancel: string
      slashHint: (command: string, description: string) => string
      cardInvalid: string
      cardConfirmed: string
    ...
    /** U4 S2 L2 workbench (route /agent/:id, spec §6). */
    supervisor: {
      title: string
      loading: string
      loadFailed: string
      ...
      workLogTitle: (subagent: string) => string
      logLoading: string
      logFailed: string
      logEmpty: string
      openFailed: string
  ...
  composer: {
    ...
    secretaryL1Placeholder: string
    secretaryL2Placeholder: (name: string) => string
  ...
  assistant: {
    ...
    tool: {
      ...
      /** 裁定 30.1: spoken read-back of project progress (`project_status`). */
      project: {
        empty: string
      ...
      /** 裁定 32.5: spoken "plan my day" (`plan_day`) reads as a done work card. */
      planDay: {
