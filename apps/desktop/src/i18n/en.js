...
export const en = {
    ...
    notifications: {
        ...
        backendOutOfDateMessage: 'Your Vaelis backend is older than this desktop build and may not work correctly. Update to align them.',
        ...
        errors: {
            ...
            methodNotAllowed: 'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Vaelis Desktop.',
    ...
    settings: {
        ...
        appearance: {
            ...
            pet: {
                title: 'Pet',
                intro: 'Adopt an animated petdex mascot that floats over the app and reacts to what Vaelis is doing — running while tools execute, celebrating on success, sulking on errors.',
                restartHint: 'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Vaelis, then come back here.',
                on: 'On',
                off: 'Off',
                scaleTitle: 'Size',
        ...
        about: {
            ...
            automaticUpdatesDesc: 'Vaelis checks for updates automatically in the background and lets you know when one is ready.',
        ...
        gateway: {
            ...
            intro: 'Vaelis Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Vaelis backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
        ...
        providers: {
            ...
            intro: 'Sign in with a subscription — no API key to copy. Vaelis runs the browser sign-in for you, right here in the app.',
            connected: 'Connected',
            collapse: 'Collapse',
            ...
            desktopQuotas: {
                ...
                intro: 'Connect the desktop apps whose subscriptions Vaelis can route through. Sign in once — Vaelis handles the rest in the background.',
                connect: 'Connect',
                connected: 'Connected',
    ...
    cron: {
        ...
        newCron: 'New cron',
        emptyDescNew: 'Schedule a prompt to run on a cron expression. Vaelis will run it and deliver results to the destination you pick.',
    ...
    sidebar: {
        ...
        projects: {
            ...
            staleBackend: 'Update the Vaelis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
    ...
    updates: {
        ...
        guiSkewBody: 'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Vaelis desktop app (your AppImage / .deb / .rpm) to match.',
        copy: 'Copy',
        copied: 'Copied',
        done: 'Done',
        applyingBody: 'The Vaelis updater takes over in its own window and reopens Vaelis automatically when it’s done. Please don’t reopen Vaelis yourself while it’s updating.',
        applyingBodyBackend: 'The remote backend is applying the update and will restart. Vaelis reconnects automatically when it’s back.',
    ...
    install: {
        ...
        failedDesc: 'One of the install steps failed. On Windows, this can happen if another Vaelis CLI or desktop instance is running. Stop any running Vaelis instances, then retry. Check the details below or the desktop log for the full transcript.',
        activeDesc: 'This is a one-time setup. The Vaelis installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
    ...
    onboarding: {
        ...
        autoBrowser: provider => `We opened ${provider} in your browser. Authorize Vaelis there and you'll be connected automatically — nothing to copy or paste.`,
    ...
    preview: {
        ...
        web: {
            ...
            stillWorking: 'Vaelis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
    ...
    assistant: {
        ...
        approval: {
            ...
            alwaysDescription: pattern => `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Vaelis won’t ask again for commands like this — in this session or any future one.`,
