...
/** Why a known Vaelis command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Vaelis profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Vaelis Agent version', surface: exec() },
 ...
 * Vaelis' built-in slash commands — i.e. skill commands (`/gif-search`,
