...
export function getAgenda(from, to) {
    ...
    return window.hermesDesktop.api({ path: `/api/agenda${suffix}` });
}
export function getPendingAgenda() {
    return window.hermesDesktop.api({ path: '/api/agenda/pending' });
}
export function createAgendaEvent(body) {
    return window.hermesDesktop.api({ path: '/api/agenda', method: 'POST', body });
}
export function updateAgendaEvent(eventId, body) {
    return window.hermesDesktop.api({
...
export function confirmAgendaEvent(eventId) {
    return window.hermesDesktop.api({
...
export function dismissAgendaEvent(eventId) {
    return window.hermesDesktop.api({
