...
import { createParticleEmitter, ParticleField } from '@/components/particles/particle-field';
...
const HEART_GLYPH = (_jsx("svg", { fill: "none", shapeRendering: "crispEdges", viewBox: "0 0 14 12", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M13.2 0v5.65714h-1.8857v1.88572H9.42857v1.88571H7.54286v1.88573H5.65714V9.42857H3.77143V7.54286H1.88571V5.65714H0V0h5.65714v1.88571h1.88572V0z", fill: "currentColor" }) }));
...
export const playVibeHearts = (count) => emitter.burst(count);
/**
 ...
 */
export const burstVibeHearts = (count) => {
...
export function HeartField({ config, className, style }) {
    return (_jsx(ParticleField, { className: className, colors: HEART_COLORS, config: config, emitter: emitter, glyph: HEART_GLYPH, style: style }));
}
/**
 ...
 */
export function PetHeartField({ petW, petH }) {
    return (_jsx(HeartField, { config: PET_HEART_CONFIG, style: {
            bottom: 0,
