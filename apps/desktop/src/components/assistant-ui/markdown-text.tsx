...
function HugeTextFallback({ containerClassName, text }: { containerClassName?: string; text: string }) {
  ...
  return (
    <div
      className={cn(
        'aui-md w-full max-w-none overflow-hidden rounded-xl border border-border font-mono text-[0.7rem] leading-relaxed text-foreground/90',
        containerClassName
      )}
    >
    ...
    () =>
      ({
        ...
        table: ({ className, ...props }: ComponentProps<'table'>) => (
          <div className="aui-md-table my-2 max-w-full overflow-x-auto rounded-md border border-border">
            <table
              className={cn(
