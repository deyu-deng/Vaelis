...
function ToolEntry({ part }: ToolEntryProps) {
  ...
  const defaultOpen = Boolean(inlineDiff) || isSecretaryDispatchTool(toolName)
    ...
    >
      ...
      {open && (
        <div className="relative grid w-full min-w-0 max-w-full gap-1.5 overflow-hidden p-1.5">
          ...
          {view.imageUrl && (
            <div className="max-w-72 overflow-hidden rounded-2xs border border-(--ui-stroke-tertiary)">
