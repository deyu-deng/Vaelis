...
export const AssistantMessage: FC<{
  ...
  const isPlaceholder = useAuiState(s => {
    ...
    // C3: a running turn that already has tool-call parts must stay visible
    // (dispatch traces). Only hide the empty pre-token placeholder.
