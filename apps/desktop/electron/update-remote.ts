 ...
 *
 * A public install can end up with `origin=git@github.com:deyu-deng/Vaelis.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/deyu-deng/Vaelis.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/deyu-deng/vaelis'
