...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Vaelis' : 'Setting up Vaelis Agent'
  const description = isUpdate
    ? 'Vaelis is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Vaelis installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
