...
Browser-based dashboard for managing Vaelis Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Vaelis Agent” — mixed case, no Mondwest, no `text-display` |
