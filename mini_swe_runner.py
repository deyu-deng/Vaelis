#!/usr/bin/env python3
"""
SWE Runner with Vaelis Trajectory Format

A runner that uses Vaelis-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Vaelis-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Vaelis-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Vaelis format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Vaelis-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Vaelis-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Vaelis Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Vaelis-Agent's built-in execution environments
    and outputs trajectories in Vaelis-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Vaelis trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Vaelis trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Vaelis trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Vaelis Trajectory Format")
    print("=" * 60)
