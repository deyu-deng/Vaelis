...
Under a gateway (Telegram, Discord, Slack, ...) Vaelis passes the
...
class TestCrossPlatformMemoryUnification:
    """The same physical user talking to Vaelis via Telegram AND Discord
...
class TestProfilePeerUniqueness:
    """Each Vaelis profile can pin to its own unique peerName.
