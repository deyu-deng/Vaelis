...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Vaelis's web-provider config and
        ...
        # native search engine for xAI sessions instead of Vaelis's
        # configured web provider (Tavily/etc.), and those results bypass
        # Vaelis's tool-trace / citation plumbing (they arrive baked into the
