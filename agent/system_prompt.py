...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Vaelis never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Vaelis itself.
    ...
    # Coding posture (base Vaelis, any interactive coding surface in a code
    ...
    # Active-profile hint — names the Vaelis profile the agent is running
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active Vaelis profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active Vaelis profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Vaelis never rebuilds or reinjects parts of it
