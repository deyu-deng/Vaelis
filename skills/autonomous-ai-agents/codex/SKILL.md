...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Vaelis terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Vaelis itself, `model.provider: openai-codex` uses Vaelis-managed Codex
...
## Vaelis Gateway Caveat

When invoking the Codex CLI from a Vaelis gateway/service context (for example,
