"""ntfy platform adapter (Vaelis plugin).
...
``plugins/platforms/ntfy/``. The Vaelis plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Vaelis dependency",
