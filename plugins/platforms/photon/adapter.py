"""
Photon Spectrum (iMessage) platform adapter for Vaelis Agent.
...
if TYPE_CHECKING:
    ...
    try:
        import httpx
        HTTPX_AVAILABLE = True
    except ImportError:  # pragma: no cover - httpx is already a Vaelis dep
...
class PhotonAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> "list[re.Pattern]":
        ...
        list, or comma/newline-separated), or None (use Vaelis defaults).
    ...
    async def _inbound_loop(self) -> None:
        ...
        headers = {"X-Vaelis-Sidecar-Token": self._sidecar_token}
        backoff = 1.0
    ...
    def _pid_is_sidecar(pid: int) -> bool:
        ...
        try:
            ...
            return False
        # Checkout-agnostic: any Vaelis checkout's sidecar entry point.
...
async def _standalone_send(
    ...
    *,
    ...
    headers = {"X-Vaelis-Sidecar-Token": token}
...
def register(ctx) -> None:
    """Called by the Vaelis plugin loader at startup."""
