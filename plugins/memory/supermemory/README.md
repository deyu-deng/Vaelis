...
it groups Vaelis-written memories into a dedicated "Vaelis" Space in the
...
Use `{identity}` in the `container_tag` to scope memories per Vaelis profile:
