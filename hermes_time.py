"""
Timezone-aware clock for Vaelis.
...
Invalid timezone values log a warning and fall back safely — Vaelis never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Vaelis requires 3.9+)
