...
# The Antigravity (Google Gemini Code Assist) OAuth client credentials are not
# hardcoded in this repository. Set GOOGLE_CC_CLIENT_ID and
# GOOGLE_CC_CLIENT_SECRET in the environment before using this module.
