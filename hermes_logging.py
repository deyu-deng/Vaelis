"""Centralized logging setup for Vaelis Agent.
...
# essentially always in Vaelis (TUI, gateway, ``hy_memory`` server, MCP
...
def setup_logging(
    *,
    ...
    """Configure the Vaelis logging subsystem.
    ...
    *force* is ``True``.
    ...
    ----------
    hermes_home
        Override for the Vaelis home directory.  Falls back to
...
# the module header): when several Vaelis processes log to the same file, an
