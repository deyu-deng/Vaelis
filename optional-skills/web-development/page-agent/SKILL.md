...
- User wants **Vaelis itself to drive a browser** → use Vaelis' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
