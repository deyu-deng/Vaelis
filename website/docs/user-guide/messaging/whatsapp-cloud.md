...
Message-template support (the workaround for outside-window sends) is not yet implemented in Vaelis. If you need it, please [open an issue](https://github.com/deyu-deng/Vaelis/issues) — it's planned but waiting on a clear demand signal.
