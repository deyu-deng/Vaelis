...
When Vaelis Agent runs inside a messaging gateway (Slack, Discord, Telegram,
...
If you use Vaelis' kanban multi-agent workflow, workers can attach
...
back into the thread as a native attachment. Vaelis Agent's deliverable
