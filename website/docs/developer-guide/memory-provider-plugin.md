...
description: "How to build a memory provider plugin for Vaelis Agent"
---

# Building a Memory Provider Plugin

Memory provider plugins give Vaelis Agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
...
the `messages` parameter; Vaelis will continue calling them with the legacy
signature.
