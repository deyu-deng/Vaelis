...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Vaelis Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Vaelis Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Vaelis core? Start with [Build a Vaelis Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Vaelis itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Vaelis instance (throwaway HERMES_HOME, separate Electron
...
- **Profile-safe paths**: Never hardcode `~/.hermes` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/deyu-deng/Vaelis/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/deyu-deng/Vaelis/blob/main/LICENSE).
