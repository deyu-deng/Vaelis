...
slug: /
sidebar_position: 0
title: "Vaelis Agent Documentation"
description: "The self-improving AI agent built by Vaelis. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Vaelis](https://vaelis.dev). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Vaelis safely  |
| 🧭 **[Use MCP with Vaelis](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Vaelis](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Vaelis voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Vaelis' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Vaelis                              |
...
- **Built by model trainers** — Created by [Vaelis](https://vaelis.dev), the lab behind Vaelis, Nomos, and Psyche. Works with [Nous Portal](https://vaelis.dev), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Vaelis](https://vaelis.dev) — the lab behind Vaelis, Nomos, and Psyche models
