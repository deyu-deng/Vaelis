...
description: "Reference for Vaelis core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call Vaelis tools programmatically. |
