  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Vaelis Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Vaelis &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Vaelis?{' '}
        <a
          href="https://github.com/deyu-deng/Vaelis/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/vaelis" target="_blank" rel="noopener noreferrer">
          Vaelis Discord
        </a>{' '}
