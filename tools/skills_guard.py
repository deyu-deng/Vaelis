...
Trust levels:
  - builtin:   Ships with Vaelis. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Vaelis secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Vaelis configuration files directly"),
...
# scan. `.skillignore` is the Vaelis-native name; `.clawhubignore` is honored
